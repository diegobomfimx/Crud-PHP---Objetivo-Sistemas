        ...
        <section class="py-5 text-center container">
            <div class="row py-lg-5">
                <div class="col-lg-6 col-md-8 mx-auto">
                    ...
                    <h3 class="fw-light">Diego Santos Ferreira</h3>
        ...
        <div class="row py-lg-5">
            <div class="col-lg-7 mx-auto">
                ...
                <form method="post" action="inserir_dados.php">
                    ...
                    <div class="mb-3">
                        <label for="nomeCliente" class="form-label"></label>
                        <input type="text" class="form-control" placeholder="Fulano da Silva Santos" name="nomeCliente">
                    </div>
                    <div class="mb-3">
                        <label for="telefoneCliente" class="form-label"></label>
                        <input type="number" class="form-control" name="telefoneCliente" placeholder="(71) 3241-3010">
                    </div>
                    <div class="mb-3">
                        <label for="observacaoCliente" class="form-label"></label>
                        <textarea class="form-control" name="observacaoCliente" placeholder="Alguma Observação Aqui !" rows="3"></textarea>
                    </div>

                    <div class="mb-3">
                        <button type="submit" class="btn btn-success mb-3" name="add_cliente">Cadastrar</button>
                    </div>
                            ...
                            <div class="card shadow-sm">
                                ...
                                ?>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <p class="card-text"><?php echo $row['id_cliente'] ?></p>
